package togetherInSpireReboosterPack.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import togetherInSpireReboosterPack.TogetherInSpireReboosterPack;
import togetherInSpireReboosterPack.util.CardStats;
import togetherInSpireReboosterPack.util.TriFunction;
...
import static togetherInSpireReboosterPack.util.GeneralUtils.removePrefix;
import static togetherInSpireReboosterPack.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return TogetherInSpireReboosterPack.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    TogetherInSpireReboosterPack.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
